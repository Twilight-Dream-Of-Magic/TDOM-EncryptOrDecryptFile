...
At present this procedure, only need to do some landscaping, as well as detailed adjustments to the manual.
Do not need to do much change.
Of course, if you need to change it. Give me a better suggestion, let me write this procedure.
...
Applies to (Linux) system (still in plan .......)
...
目前这个程序，只需要做一些美化，还有说明书的详细调整。
不需要做什么太大的改动。
当然，如果你需要改动的话。给我更好的建议，让我去编写这个程序。
