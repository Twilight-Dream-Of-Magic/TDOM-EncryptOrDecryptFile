...
{
	remove(".//SourceFileName.CONFIGFILE");
	remove(".//SourceFileMainName.CONFIGFILE");
	remove(".//SourceFileExtendedName.CONFIGFILE");

	/*system("rm --recursive --force");*/

	system("rm --force .//File-Key-Record-Log//*.*");
	system("rm --force .//WorkPath//.*");

	system("rm --force .//WorkPath//Encrypt//*.*");
	system("rm --force .//WorkPath//Encrypt//InputFile//*.*");
	system("rm --force .//WorkPath//Encrypt//OutputFile//*.*");

	system("rm --force .///WorkPath//Decrypt//*.*");
	system("rm --force .//WorkPath//Decrypt//InputFile//*.*");
	system("rm --force .//WorkPath//Decrypt//OutputFile//*.*");

	system("rm --force --dir .//File-Key-Record-Log//");

	system("rm --force --dir .//WorkPath//Encrypt//OutputFile//");
	system("rm --force --dir .//WorkPath//Encrypt//InputFile//");
	system("rm --force --dir .//WorkPath//Encrypt//");

	system("rm --force --dir .//WorkPath//Decrypt//OutputFile//");
	system("rm --force --dir .//WorkPath//Decrypt//InputFile//");
	system("rm --force --dir .//WorkPath//Decrypt//");
	system("rm --force --dir .//WorkPath//");
...
/****************************************************************************************************************************************************************/
	...
	if (Load_User_Keyboard_Input == "1")
	{
		...
		system("echo -e '\033[40m'"); //Linux Console Backgroud Color: Black
		system("echo -e '\033[0;92m'"); //Linux Console Foregroud Color: Light Green

		system("echo -e '\033[40;92m'");
	 ...
	 Instruction_Manual_Language_Restart:
	  system("clear");
		...
		if (Instruction_Manual_Language == "enUS")
		{
			...
			system("echo -e '\033[43m'"); //Linux Console Backgroud Color: Yellow
			system("echo -e '\033[0;37m'"); //Linux Console Foregroud Color: White
...
/****************************************************************************************************************************************************************/
	...
	Waring_Information:
		...
		system("echo -e '\033[40m'"); //Linux Console Backgroud Color: Black
		system("echo -e '\033[0;91m'"); //Linux Console Foregroud Color: Light Red

		system("echo -e '\033[40;91m'");
